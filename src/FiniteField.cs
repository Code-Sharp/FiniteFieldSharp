...
namespace FiniteFieldSharp
{
    public class GaloisFieldWithTable: IEquatable<GaloisFieldWithTable>
    {
        ...
        public GaloisFieldElement Identity { get; }
        ...
        public GaloisFieldWithTable(int characteristic, int degree)
        {
            ...
            this.Identity = new GaloisFieldElement(new int[Degree-1].Prepend(1).ToArray(), this);
            ...
            mLogarithmicTable[Identity] = 0;
            mExponentialTable[0] = Identity;
